...
export interface TestInvalidZoneInterface extends utils.Interface {
  functions: {
...
export interface TestInvalidZone extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestInvalidZoneInterface;
